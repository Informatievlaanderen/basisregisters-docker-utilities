...
Target.create "Lib_Build" (fun _ ->
    buildSolution "basisregisters-docker-utilities"
)

Target.create "Test_Solution" (fun _ -> test "basisregisters-docker-utilities")

Target.create "Lib_Publish" (fun _ ->
    publishSource "Be.Vlaanderen.Basisregisters.DockerUtilities"
)

Target.create "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.DockerUtilities")
